...
const algorithmOptions = [
  ...
  { value: "uniform-cost", label: "Uniform Cost Search" },
  ...
  { value: "bidirectional-greedy", label: "Bidirectional Greedy Search" },
    ...
    <>
      <header className="header">
        <div className="header-copy">
          ...
          <p>
            An interactive AI pathfinding studio for comparing shortest-path
            behavior, heuristic trade-offs, and search efficiency across real
            grid scenarios.
          </p>
        </div>
      ...
      <div className="control-bar">
        {activePage === "visualizer" && (
          <>
            ...
            <button
              onClick={() =>
                setDrawingMode(drawingMode === "wall" ? "weight" : "wall")
              }
              className={drawingMode}
            >
