...
const algorithmLessons = [
  ...
  },
  {
    ...
    guarantees: 'Optimal with admissible heuristic; strongest behavior with consistent heuristic.',
    pitfalls: [
  ...
  },
  {
    ...
    guarantees: 'Complete on finite graphs with positive costs; not guaranteed optimal for w > 1.',
    pitfalls: [
  ...
  },
  {
    ...
    guarantees: 'Optimal shortest path with correct stopping condition and non-negative weights.',
    pitfalls: [
  ...
  },
  {
    ...
    guarantees: 'Complete for finite branching and shallowest-solution optimality in unweighted settings.',
    pitfalls: [
...
function LearningPage() {
  ...
  const activeLesson = useMemo(
    () => algorithmLessons.find((lesson) => lesson.id === activeId) ?? algorithmLessons[0],
    [activeId],
  );
  ...
  return (
    <section className="learning-page">
      <div className="learning-hero">
        ...
        <p>
          Open one algorithm at a time to get a dedicated learning page with intuition,
          complexity, guarantees, pitfalls, and practical internet-scale relevance.
        </p>
      </div>
      ...
      <div className="learning-layout">
        ...
        <article className="lesson-detail" aria-live="polite">
          ...
          <section className="lesson-section two-col">
            <div>
              <h4>Complexity</h4>
              <p><strong>Time:</strong> {activeLesson.complexity.time}</p>
              <p><strong>Space:</strong> {activeLesson.complexity.space}</p>
            </div>
            <div>
              <h4>Guarantees</h4>
